  ...
  const milestones = [
    {
      coins: 500,
      reward: "Bronze Badge",
      achieved: userProfile.skillCoins >= 500,
    },
    {
      coins: 1000,
      reward: "Silver Badge",
      achieved: userProfile.skillCoins >= 1000,
    },
    {
      coins: 2500,
      reward: "Gold Badge",
      achieved: userProfile.skillCoins >= 2500,
      progress: (userProfile.skillCoins / 2500) * 100,
    },
    {
      coins: 5000,
      reward: "Platinum Badge",
      achieved: userProfile.skillCoins >= 5000,
      progress: (userProfile.skillCoins / 5000) * 100,
    },
  ];
  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-background">
          ...
          <div className="p-4 md:p-6 max-w-7xl mx-auto">
            ...
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">
                Exchange your Skill Coins for real rewards!
              </p>
            </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold">
                        {userProfile.skillCoins?.toLocaleString() ?? "0"} Skill
                        Coins
                      </h2>
                      <p className="text-muted-foreground">
                  ...
                  {recentRedemptions.map((redemption) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <Badge
                          variant={
                            redemption.status === "Ready for pickup"
                              ? "default"
                              : "secondary"
                          }
                          className="text-xs"
                      ...
                      {!milestone.achieved && (
                        <div className="space-y-1">
                          ...
                          <p className="text-xs text-muted-foreground">
                            {milestone.coins - userProfile.skillCoins} coins to
                            go
                          </p>
                        </div>
                      )}
        ...
        >
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Your voucher has been generated. Show this code to the partner
                store to claim your reward.
              </DialogDescription>
            </DialogHeader>
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      ...
                      {selectedStore.isOpen !== null && (
                        <Badge
                          variant={
                            selectedStore.isOpen ? "default" : "secondary"
                          }
                          className="text-xs"
                        >
        ...
        <Dialog
          open={showLocationFinder}
          onOpenChange={handleLocationFinderClose}
        >
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            {selectedItem && (
              <LocationFinder
                rewardType={
                  selectedCategory as "food" | "hygiene" | "connectivity"
                }
